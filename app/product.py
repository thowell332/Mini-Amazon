...
def product(input, sort):
    ...
    if sort == "quantity-ordered":
        product = Product.get_product_display_page(input, "quantity")
    elif sort == "price-ordered":
        product = Product.get_product_display_page(input, "price")
    else:
        product = Product.get_product_display_page(input, "seller_id")
