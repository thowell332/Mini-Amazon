...
''',
    ...
    def submit_product_review(user_id, product_id, num_stars, date, description, upvotes, images):
        try: app.db.execute('''
INSERT INTO ProductReview VALUES (:user_id, :product_id, :num_stars, :date, :description, :upvotes, :images)
        ''', user_id=user_id, product_id=product_id, num_stars=num_stars, date=date, description=description, upvotes=upvotes, images=images)
        except Exception as e:
            print(e)

    @staticmethod
    ##Method to update a selected product review authored by user with user_id
    def update_product_review(user_id, product_id, num_stars, date, description, upvotes, images):
        try: app.db.execute('''
...
WHERE buyer_id = :user_id AND product_id = :product_id
        ''', user_id=user_id, product_id=product_id, num_stars=num_stars, date=date, upvotes=upvotes, description=description)
        except Exception as e:
            print(e)
...
''',
    ...
    def submit_seller_review(user_id, seller_id, num_stars, date, description, upvotes, images): 
        try: app.db.execute('''
INSERT INTO SellerReview VALUES (:user_id, :seller_id, :num_stars, :date, :description, :upvotes, :images)
        ''', user_id=user_id, seller_id=seller_id, num_stars=num_stars, date=date, description=description, upvotes=upvotes, images=images)
        except Exception as e:
            print(e)

    @staticmethod
    ##Method to update a selected seller review authored by user with user_id 
    def update_seller_review(user_id, seller_id, num_stars, date, description, upvotes, images):
        try: app.db.execute('''
